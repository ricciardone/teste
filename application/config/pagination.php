...
$config['num_links'] = 2;	//The number of "digit" links you would like before and after the selected page number. For example, the number 2 will place two digits on either side, as in the example links at the very top of this page.
...
$config['page_query_string'] = TRUE;	//By default, the pagination library assume you are using URI Segments, and constructs your links something like
/*
...
$config['first_tag_open'] 	= '<div>';	//The opening tag for the "first" link.
$config['first_tag_close'] 	= '</div>';	//The closing tag for the "first" link.
...
$config['last_tag_open'] 	= '<div>';		//The opening tag for the "last" link.
$config['last_tag_close'] 	= '</div>';	//The closing tag for the "last" link.
...
$config['next_tag_open'] 	= '<div>';		//The opening tag for the "next" link.
$config['next_tag_close'] 	= '</div>';	//The closing tag for the "next" link.
...
$config['prev_tag_open'] 	= '<div>';		//The opening tag for the "previous" link.
$config['prev_tag_close'] 	= '</div>';	//The closing tag for the "previous" link.

//Customizing the "Current Page" Link

$config['cur_tag_open'] 	= '<b>';		//The opening tag for the "current" link.
$config['cur_tag_close'] 	= '</b>';		//The closing tag for the "current" link.

//	Customizing the "Digit" Link

$config['num_tag_open'] 	= '<div>';		//The opening tag for the "digit" link.
$config['num_tag_close'] 	= '</div>';	//The closing tag for the "digit" link.
